...
in both HTML and negotiated Markdown today -- see `docs/agent-discovery.md`.
The accepted reference-discovery architecture will keep it as a collapsed
optional HTML artifact, remove it from default Markdown, and expose it only
through a deliberately selected prompt-text route. See
